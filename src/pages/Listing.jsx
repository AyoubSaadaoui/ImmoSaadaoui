        ...
        <div className='m-4 flex flex-col md:flex-row max-w-6xl lg:max-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5'>
            <div className='w-full '>
                ...
                {listing.userRef !== auth.currentUser?.uid && !contactLandlord &&(
                    <div className='mt-6'>
                        <button
                            className='px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg w-full text-center transition duration-150 ease-in-out mb-6'
                ...
                {contactLandlord && (<Contact listing={listing} userRef={listing.userRef}/>)}

            </div>
            <div className='w-full h-[200px] md:h-[400px] z-10 overflow-x-hidden lg:mt-0 mb-6 md:mb-0 md:ml-1 '>
                <MapContainer
